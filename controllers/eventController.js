...
class EventController {
 async createEvent(req, res, next) {
  try {
    ...
    // Create event first without tiers
    const event = new Event({
      ...
      bannerUrl,
      guests: guests || [],
      // publicId will be generated by pre-validate hook
    });
    ...
    // Save the event (this will trigger validation and generate publicId)
    await event.save();
    ...
    // Get populated tiers
    const populatedTiers = await TicketTier.find({ _id: { $in: createdTiers } });
